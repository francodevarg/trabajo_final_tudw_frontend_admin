    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-5 space-y-1">
      ...
      >
        ...
        <ChevronRight
          ...
          class="w-3.5 h-3.5 ml-auto text-primary-400 flex-shrink-0"
        />
      </button>
    </nav>
    ...
    <div class="px-3 py-3 border-t border-slate-100">
      <div class="flex items-center gap-3 px-1">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-sm font-medium text-slate-800 truncate leading-tight">{{ auth.userFirstName }} {{ auth.userLastName }}</p>
