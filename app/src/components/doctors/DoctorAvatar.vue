...
const colorClass = computed(() => {
  // Generamos un numero basado en el nombre del doctor para asignar un color consistente.
  const hash = [...(props.firstName + props.lastName)].reduce((a, c) => a + c.charCodeAt(0), 0)
  // Devolvemos un color, Con % El índice esta dentro de los límites del arreglo.
