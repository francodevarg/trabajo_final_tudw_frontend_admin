...
const emit = defineEmits<{
  (e: 'edit', item: Insurance): void
  (e: 'delete', item: Insurance): void
}>()
</script>
...
<template>
  ...
  >
    ...
    <p class="text-sm font-medium text-slate-600">No hay obras sociales</p>
        ...
        >
          ...
          <td class="px-5 py-3.5">
            <div class="flex items-center justify-end gap-1">
              <button
                v-permission="'doctor.change_insurance'"
              ...
              <button
                v-permission="'doctor.delete_insurance'"
